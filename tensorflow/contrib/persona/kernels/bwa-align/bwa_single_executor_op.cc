...
namespace tensorflow {
  ...
  class BWASingleExecutorOp : public OpKernel {
  public:
    typedef BasicContainer<BWASingleExecutor> ExecutorContainer;

    BWASingleExecutorOp(OpKernelConstruction* context)
  ...
  REGISTER_KERNEL_BUILDER(Name("BWASingleExecutor").Device(DEVICE_CPU), BWASingleExecutorOp);
}  // namespace tensorflow
